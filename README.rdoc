...
*TODO*: Implement +global_setup+ and +global_teardown+ (analogous to
<tt>before(:all)</tt> and <tt>after(:all)</tt> in rspec.)

== Nested contexts

*TODO*: We will support nested contexts like rspec[http://rspec.info] or
Contest[http://github.com/citrusbyte/contest] allows for Test::Unit.
